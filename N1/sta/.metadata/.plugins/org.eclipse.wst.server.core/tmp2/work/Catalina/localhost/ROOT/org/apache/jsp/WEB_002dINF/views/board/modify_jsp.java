 ...
 * Generated at: 2019-09-30 01:07:37 UTC
...
public final class modify_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\">                \t\t\t\t\r\n");
      out.write("                \t\t\t\t</div>  \r\n");
      out.write("                \t\t\t\t<button type=\"submit\" data-oper='modsfy' class=\"btn btn-default\">Modify</button>              \t\t\t\r\n");
      ...
      out.write("\t\t\t\t$(function(){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t//remove 와 list 버튼 클릭시 사용할 폼 가져오기\r\n");
      out.write("\t\t\t\t\tvar form=$(\"form[name='form1']\");\r\n");
      out.write("\t\t\t\t\t$(\"button\").click(function(e){\r\n");
      out.write("\t\t\t\t\t\t//submit기능 막기\r\n");
      out.write("\t\t\t\t\t\te.preventDefault();\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tvar oper=$(this).data(\"oper\");\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tif(oper==='list'){//새로만든 폼 보내기\r\n");
      out.write("\t\t\t\t\t\t\tform.find(\"input[name='bno']\").remove();\r\n");
      out.write("\t\t\t\t\t\t\tform.attr(\"action\",\"/board/list\");\r\n");
      out.write("\t\t\t\t\t\t\tform.attr(\"method\",\"get\");\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t}else if(oper==='remove'){//새로마든 폼 보내기\r\n");
      out.write("\t\t\t\t\t\t\tform.attr(\"action\",\"/board/remove\");\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t}else if(oper==='modify'){\r\n");
      out.write("\t\t\t\t\t\t\t//원래 폼 보내기\r\n");
