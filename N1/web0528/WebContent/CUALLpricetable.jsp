  ...
  <div class="wrapper">
    ...
    <div class="products category">
        <ul class="">
            <li>
                <div class="wrapimg">
                    <img src="img/gokmul.png">
                    <div class="addPro"><a href="item.do?item=<%="옛날당면"%>&shop=<%="CU(본사)"%>&id=<%="dang"%>&img=<%=request.getContextPath()%>/img/CU.png">상품정보</a>
                   
                    </div>
                </div>
                <div class="titlePro">	<a href="item/gukmul.jsp">Samsung EC ST500</a>
 <span>$ 145.00</span>
            ...
            <li>
                <div class="wrapimg">
                    <img src="img/gokmul.png">
                    <div class="addPro"><a href="item.do?item=<%="옛날당면"%>&shop=<%="CU(본사)"%>&id=<%="dang"%>&img=<%=request.getContextPath()%>/img/gokmul.png">상품정보</a>
